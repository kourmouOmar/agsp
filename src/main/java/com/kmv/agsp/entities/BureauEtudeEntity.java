...
/**
 * Persistent class for entity stored in table "bureau_etude"
 */
...
@AllArgsConstructor
@ToString
public class BureauEtudeEntity extends AbstractCommonEntity<Long>  implements Cloneable  {
	...
	@Column(name = "id_bureau_etude", nullable = false)
    ...
    @OneToMany(mappedBy="bureauEtude", targetEntity=ProjetEntity.class)
    private List<ProjetEntity> listOfProjet;


     @Override
	 public Long getId() {
		return idBureauEtude;
	} 
